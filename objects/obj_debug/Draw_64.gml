...
if(room=room_games&&instance_exists(obj_game_selection)){
	...
	//draw_phase="Phase:["+string(obj_game_selection.phase)+"/"+string(obj_game_selection.phases)+"]"
	//draw_warning_color="Warning Color:["+string(obj_game_selection.warning_color)+","+string(obj_game_selection.warning_countdown)+"]"
