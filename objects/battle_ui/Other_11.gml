...
draw_text(x+245+hp_bar_lock*1.25+14,y,string(Player_GetHp())+" / "+string(Player_GetHpMax()));}
	...
	if(battle.shield=true){
		...
		draw_sprite_ext(spr_pixel,0,x+245,y-1+21,(hp_bar_lock*1.25)/120*battle.shieldval,5,0,c_lime,1);
		}else{
		draw_sprite_ext(spr_pixel,0,x+245,y-1+21,(hp_bar_lock*1.25)/120*battle.shieldval,5,0,make_color_rgb(255,255,255),1);}
		event_user(2)
    }