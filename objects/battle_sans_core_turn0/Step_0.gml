...
case 10480:
	...
	if(IsEng()){d.text="{font 3}{voice 3}{sans_core_face 3}okay,{sleep 15}&you are still alive{pause}{clear}{sans_core_face 1}why are you looking at&me with that look{pause}{clear}{sans_core_face 2}are you hoping the core&blow up and kill me?{pause}{clear}{sans_core_face 1}come on,{sleep 15}&i am not stupid like that{pause}{clear}{sans_core_face 3}i just,{sleep 15}&having a rest{pause}{clear}you know,{sleep 15}{sans_core_face 1}&i'm tired to the \"bone\"&after such a high-intensity&battle like this{pause}{sans_core_face 3}{sans_core_ending}{end}"}
	if(IsChs()){d.text="{font 3}{voice 3}{sans_core_face 3}好吧,{sleep 15}&你居然活下来了{pause}{clear}{sans_core_face 1}你怎么用那种眼神看着我{pause}{clear}{sans_core_face 2}难不成你还期待着&核心突然爆炸把我炸死吗?{pause}{clear}{sans_core_face 1}拜托,{sleep 15}&我哪有那么蠢{pause}{clear}{sans_core_face 3}我只是,{sleep 15}&先休息会{pause}{clear}你知道,{sleep 15}{sans_core_face 1}&这么高强度的战斗可是&让我累到了“骨子”里{pause}{sans_core_face 3}{sans_core_ending}{end}"}
	break
}
