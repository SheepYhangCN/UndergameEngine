if(_state==0){
	...
	_inst_inventory.text=_prefix+GetString("str_ui_box_inventory")
	_inst_box.text=_prefix+GetString("str_ui_box_box")
	_inst_finish.text=_prefix+GetString("str_ui_box_finish")
