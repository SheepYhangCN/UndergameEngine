...
if (type == 2)
    blend = c_orange//make_gracolor_rgb(248, 148, 29)
if (type == 3)
    blend = c_lime
...
if (out == 0)
{
    ...
    draw_sprite_ext(_spr_bone_body, 0, x, y, (length / 2), 1, angle, blend, 1)
    draw_sprite_ext(_bone_end, 0, (x - lengthdir_x((length / 2)*(vspeed<0 ? -1 : 1), angle)), (y + lengthdir_x((length / 2), (angle - 90))), 1, 1, (angle + 180), blend, 1)
    draw_sprite_ext(_bone_end, 1, (x + lengthdir_x((length / 2)*(vspeed<0 ? -1 : 1), angle)), (y - lengthdir_x((length / 2), (angle - 90))), 1, 1, (angle + 180), blend, 1)
