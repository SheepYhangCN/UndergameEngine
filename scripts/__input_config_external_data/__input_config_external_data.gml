...
#macro INPUT_SDL2_DATABASE_PATH    working_directory+"Input/sdl2.txt"                //Path to the SDL2 database to read gamepad remapping definitions from
#macro INPUT_CONTROLLER_TYPE_PATH  working_directory+"Input/controllertypes.csv"     //Path to the controller type database to read gamepad types from
#macro INPUT_BLACKLIST_PATH        working_directory+"Input/controllerblacklist.csv" //Path to the controller blacklist database to read from